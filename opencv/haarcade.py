# -*- coding: utf-8 -*-
"""
Created on Sat Jul  6 17:40:43 2019
...
faces= faceCasc.detectMultiScale(grayColors,1.5,3)
...
for(x,y,w,h) in faces:
    cv2.rectangle(img,(x,y),(x+w,y+h),(0,255,0),1) #Çerçevenin konumu, rengi ve kalınlığı
